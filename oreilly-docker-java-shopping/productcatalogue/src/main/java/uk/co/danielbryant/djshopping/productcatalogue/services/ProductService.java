...
public class ProductService {
    ...
    public ProductService() {
        ...
        fakeProductDAO.put("7", new Product("7", "Car", "Zen", new BigDecimal(2055.30)));
        fakeProductDAO.put("8", new Product("8", "Car", "City Honda", new BigDecimal(4056.70)));
        fakeProductDAO.put("9", new Product("9", "Car", "Create", new BigDecimal(5634.50)));
